...
const JCTM_KNOWLEDGE = [
  ...
  },
  {
    ...
    content: `The Warri City Crusade 2026 was a major outdoor evangelical crusade organized by Jesus Christ Temple Ministry (JCTM) — now concluded. It took place April 30 – May 1, 2026, at Ighogbadu Primary School, Okumagba Avenue, Warri, Delta State, Nigeria. Organized by JCTM under Prophet Amos Evomobor. Theme: "Be Ready For Rapture: Tribulation Is Coming! Run For Your Soul!" The crusade featured open-air gospel preaching, healing and miracle services, worship, testimonies, and doctrinal teachings from the Correction Mandate. It drew thousands from across the Niger Delta region. Video coverage may be available on Temple TV (@TEMPLETVJCTM). For upcoming JCTM events, visit jctm.org.ng/events.`,
  },
  {
...

  {
    ...
    content: `The JCTM Ministers Conference 2026 was a three-day apostolic gathering — now concluded. Event title: "Ministers Conference 2026 — Apostolic Fire." Theme: "Come, receive your apostolic fire from the altar of God." Held Friday 8 May through Sunday 10 May 2026 at JCTM Church Auditorium, Km 1 East West Road, Ebrumede Roundabout, Effurun Uvwie LGA, Delta State, Nigeria. The conference featured deep apostolic ministry under Prophet Amos Evomobor, Holy Spirit impartation, sound doctrinal teaching from the Correction Mandate, and prophetic ministry. Video recordings may be available on Temple TV (@TEMPLETVJCTM). For upcoming JCTM conferences and events, visit jctm.org.ng/events or contact info@jctm.org.ng.`,
  },
  ...
  // ── EXPANDED KNOWLEDGE BASE v7.0 — New topics: Platform, Lifestyle, Theology ──

  {
    source: "templebots-ai-assistant",
    content: `TempleBots is the official AI ministry intelligence assistant of Jesus Christ Temple Ministry (JCTM), built into the JCTM Digital Sanctuary at jctm.org.ng. It operates as a 24/7 digital ministry servant — available to everyone around the world at any time. What TempleBots can help with: 1. Ministry information — JCTM's doctrine, history, location, services, and events. 2. Theological questions — biblical teaching grounded in Primitive Christianity and the Correction Mandate. 3. Pastoral support — scripture-based encouragement for anxiety, grief, doubt, and life struggles. 4. Prayer assistance — TempleBots can pray with you and point you to scripture. 5. Sermon recommendations — finding the right Temple TV teaching for your specific need. 6. Giving guidance — how to support JCTM's mission online. 7. Event information — current JCTM conferences, crusades, and church programmes. TempleBots is powered entirely by local AI — all intelligence runs on JCTM's own platform with no external AI dependency. It is grounded in JCTM's knowledge base of doctrine, sermons, devotionals, and testimonies. For complex pastoral needs, contact info@jctm.org.ng or +234(0)8081313111.`,
  },
  {
    source: "jctm-digital-sanctuary-features",
    content: `The JCTM Digital Sanctuary (jctm.org.ng) is the official online platform of Jesus Christ Temple Ministry — a comprehensive, feature-rich ministry hub designed to serve believers globally. Key features: 1. Sermon Library — browse and watch hundreds of Temple TV sermons organized by topic, series, and date. 2. Live Stream — watch JCTM services live on Temple TV (Sunday 8 AM – 12 PM WAT, Wednesday 5 PM – 8 PM WAT). 3. Daily Devotions — scripture-based devotionals delivered fresh each morning; subscribe for email delivery. 4. Prayer Wall — submit personal prayer requests; JCTM's prayer team intercedes for every request. 5. Testimony Vault — share how God has moved in your life; be an encouragement to the global community. 6. Ministry Moments — short, shareable video teachings from Prophet Amos and JCTM ministers. 7. Global Altar 3D — a real-time visual representation of believers praying simultaneously around the world. 8. TempleBots — 24/7 AI ministry assistant for theological questions, prayer, and pastoral support. 9. Events — register for JCTM conferences, crusades, and special programmes. 10. Giving Portal — secure online giving via Paystack (Nigeria) and Stripe (international). 11. Member Portal — register as a JCTM community member for personalized ministry experience. All features are free to access. jctm.org.ng.`,
  },
  {
    source: "how-to-join-jctm",
    content: `Joining Jesus Christ Temple Ministry (JCTM) is straightforward — JCTM welcomes all who desire to walk in sound doctrine and Primitive Christianity. How to connect: 1. Attend a Sunday service at Ebrumede Temple, Warri, Delta State (8:00 AM – 12:00 PM WAT). 2. Watch Temple TV (YouTube @TEMPLETVJCTM) to experience services online before visiting. 3. Register on the Digital Sanctuary — visit jctm.org.ng and create a member account to access all platform features. 4. Contact the ministry at info@jctm.org.ng or +234(0)8081313111 to speak with a pastoral team member. 5. Find a JCTM viewing centre near you — the ministry has fellowship points across Nigeria; contact the ministry for the nearest location. 6. Participate in the prayer wall, testimony vault, and community features at jctm.org.ng. Water baptism (full immersion) is available for new converts who have confessed faith in Christ — contact the ministry to arrange a baptism appointment. JCTM does not charge membership fees. Membership is based on genuine faith, commitment to sound doctrine, and consistent fellowship.`,
  },
  {
    source: "jctm-founding-history",
    content: `Jesus Christ Temple Ministry (JCTM) was founded on January 3, 2013 by Prophet Amos Evomobor in Warri, Delta State, Nigeria. The founding followed a divine encounter in which Prophet Amos received the Correction Mandate — a specific divine assignment to identify and correct five major doctrinal errors that have corrupted modern Christianity. JCTM began as a small fellowship in Warri and has grown into a global ministry reaching believers in 40+ nations through Temple TV (YouTube @TEMPLETVJCTM). The ministry is headquartered at Ebrumede Temple, located at Km 1 East West Road, Ebrumede Roundabout, Effurun Uvwie LGA, Delta State, Nigeria. Key milestones: 2013 — Ministry founded. 2015 — Temple TV YouTube channel launched. 2020 — Global digital expansion; believers in multiple continents. 2024 — JCTM Digital Sanctuary (jctm.org.ng) launched. 2026 — Warri City Crusade (April 30 – May 1) and Ministers Conference (May 8-10) demonstrate the ministry's growing reach. JCTM remains a non-denominational, doctrine-first ministry committed to holiness and the original apostolic faith.`,
  },
  {
    source: "sexuality-gender-biblical-position",
    content: `JCTM holds the clear, uncompromising biblical position on human sexuality and gender: 1. God created humanity male and female (Genesis 1:27) — biological sex is not fluid or self-determined; it is divinely assigned. 2. Marriage is exclusively between one man and one woman (Genesis 2:24, Matthew 19:4-6). No other arrangement carries the divine sanction or blessing of marriage. 3. Homosexuality is identified in scripture as sin (Romans 1:26-27, 1 Corinthians 6:9-11, Leviticus 18:22). JCTM's position: we do not hate individuals who struggle with same-sex attraction, but we will not affirm homosexual practice as compatible with Christianity. 4. Churches that affirm and celebrate homosexuality have departed from Primitive Christianity — this is one expression of the "falling away" prophesied in 2 Thessalonians 2:3 and a subject addressed by the Correction Mandate. 5. Transgenderism — the belief that one can change or choose one's gender — contradicts the Creator's design and is not supported by scripture. 6. Grace and repentance are available to all — 1 Corinthians 6:11: "Such were some of you. But you were washed, but you were sanctified, but you were justified in the name of the Lord Jesus." JCTM ministers to those struggling with sexual sin with both truth and compassion.`,
  },
  {
    source: "new-covenant-vs-old-covenant",
    content: `JCTM teaches the distinction between the Old Covenant (Mosaic Law) and the New Covenant (established by Christ's blood) as essential for proper biblical interpretation. The Old Covenant: given to Israel through Moses at Sinai; included 613 commandments covering moral, civil, and ceremonial law; was a tutor pointing to Christ (Galatians 3:24). The New Covenant: prophesied in Jeremiah 31:31-34, inaugurated by Jesus at the Last Supper (Luke 22:20), and fully operational after Christ's death and resurrection. Key differences: 1. The New Covenant is universal — for all nations, not just Israel (Galatians 3:28). 2. The law is written on the heart (Jeremiah 31:33), not stone tablets. 3. Righteousness comes by faith in Christ, not law-keeping (Romans 3:21-22). 4. Ceremonial laws (animal sacrifice, dietary laws, Jewish festivals) are fulfilled in Christ and no longer binding on Christians (Hebrews 10:1-10, Colossians 2:16-17). 5. The moral law (Ten Commandments minus the Saturday Sabbath) is upheld and intensified by Jesus (Matthew 5). Practical implication: Christians are not under the law for salvation but are free in Christ — this freedom is not a license for sin (Romans 6:1-2) but for righteousness (Romans 8:4).`,
  },
  {
    source: "how-to-study-bible",
    content: `JCTM teaches believers practical methods for effective personal Bible study — essential for growth in Primitive Christianity. Step-by-step approach: 1. Set a specific time and place — preferably morning before the day's distractions. 2. Begin with prayer — ask the Holy Spirit to illuminate the Word (1 Corinthians 2:13-14). 3. Read in context — never pull a single verse out of context; read the surrounding passages and understand the audience, occasion, and purpose. 4. Use a concordance or Bible dictionary to look up key Greek or Hebrew words — especially for doctrinal passages. 5. Cross-reference — use scripture to interpret scripture; let the Bible explain itself. 6. Write down insights — journaling reinforces learning and tracks spiritual growth. 7. Apply what you read — James 1:22: "Be doers of the word, and not hearers only, deceiving yourselves." 8. Study topically — use JCTM's topics section at jctm.org.ng for organized biblical studies. 9. Use the NKJV or KJV — JCTM recommends these for their faithfulness to the original texts. Key books for new believers: John, Romans, Ephesians, and the Psalms. For mature believers: systematic study of all 66 books. Consistency is more valuable than lengthy occasional sessions.`,
  },
  {
    source: "overcoming-sin-temptation",
    content: `Every believer faces temptation — this is not sin in itself (Jesus was tempted, Hebrews 4:15). Sin occurs when we yield to temptation. JCTM's practical teaching on overcoming sin and temptation: 1. Know your triggers — identify the specific contexts, relationships, and emotions that make you vulnerable (1 Corinthians 10:13). 2. Flee — sometimes the only response is to run (2 Timothy 2:22: "Flee youthful lusts"). Joseph fled from Potiphar's wife (Genesis 39:12). 3. Be filled with the Spirit — Spirit-filled living crowds out the works of the flesh (Galatians 5:16: "Walk in the Spirit and you shall not fulfill the lust of the flesh"). 4. Saturate yourself with the Word — Psalm 119:11: "Your word I have hidden in my heart, that I might not sin against You." 5. Accountability — find a trustworthy, mature believer who will pray for you and check on your progress (James 5:16). 6. Confess quickly — 1 John 1:9: "If we confess our sins, He is faithful and just to forgive us our sins and to cleanse us from all unrighteousness." Do not let guilt accumulate. 7. Understand grace is not a license — Romans 6:1-2: "Shall we continue in sin that grace may abound? Certainly not!" Submit prayer requests for deliverance at jctm.org.ng/prayer.`,
  },
  {
    source: "rapture-readiness-practical",
    content: `JCTM's message of rapture readiness is not just eschatological information — it is a call to daily, practical holiness. How to be rapture-ready according to JCTM's teaching: 1. Be genuinely born again — John 3:3: "Unless one is born again, he cannot see the kingdom of God." Confirm your salvation is real, not nominal. 2. Live in active holiness — Matthew 24:44: "Therefore you also be ready, for the Son of Man is coming at an hour you do not expect." Holiness is not optional for rapture candidates. 3. Do not love the world — 1 John 2:15-17: "Do not love the world or the things in the world." Attachment to materialism, entertainment, and worldly systems is a rapture-readiness risk. 4. Be watchful and prayerful — Luke 21:36: "Watch therefore, and pray always that you may be counted worthy to escape all these things that will come to pass, and to stand before the Son of Man." 5. Share the gospel urgently — if you believe the rapture is near, your unsaved family and friends need to know Christ now. The Warri City Crusade 2026 theme "Be Ready For Rapture: Tribulation Is Coming! Run For Your Soul!" captures this urgency. 6. Stay in sound, doctrinally correct fellowship — Hebrews 10:25: "Not forsaking the assembling of ourselves together, and so much the more as you see the Day approaching."`,
  },
  {
    source: "viewing-centres-network",
    content: `JCTM has established viewing centres — community fellowship points where believers watch Temple TV services together, share fellowship, and receive ministry locally. Viewing centres are ideal for: believers who cannot travel to Ebrumede Temple in Warri, new converts who want structured fellowship close to home, communities with no sound-doctrine church nearby. How viewing centres work: They operate under JCTM's oversight and doctrinal standards. A local coordinator hosts the fellowship, streams Temple TV live or recorded services, and facilitates prayer and discussion. Viewing centre activities: Sunday service streaming (8 AM WAT), mid-week study groups, prayer meetings, outreach coordination. To find a viewing centre near you: contact info@jctm.org.ng or visit jctm.org.ng/viewing-centres. To start a viewing centre in your community: contact JCTM with your location details. JCTM provides material support and doctrinal oversight for approved viewing centres. This network is part of JCTM's strategy to bring sound, Correction Mandate teaching to communities across Nigeria and beyond.`,
  },
  {
    source: "importance-of-church-attendance",
    content: `JCTM strongly teaches that regular church attendance is not optional for genuine Christians. Biblical basis: Hebrews 10:25: "Not forsaking the assembling of ourselves together, as is the manner of some, but exhorting one another, and so much the more as you see the Day approaching." Acts 2:42-47: The early church met daily for teaching, fellowship, breaking of bread, and prayer. Why church attendance matters: 1. Spiritual accountability — you cannot grow in isolation; the church provides checks, correction, and encouragement. 2. Corporate worship — Psalm 22:3: God inhabits the praises of His people; corporate worship creates a dimension unavailable in private devotion. 3. Teaching and doctrine — Romans 10:17: "Faith comes by hearing, and hearing by the word of God." Regular exposure to sound teaching builds doctrinal strength. 4. Belonging and identity — 1 Corinthians 12:12-20: You are a member of the body of Christ; the body suffers when members are absent. 5. Service — the church is the context for exercising your spiritual gifts (Romans 12:5-8). JCTM warns against "home Christianity" or "YouTube Christianity" as a permanent substitute for corporate fellowship. Temple TV and the Digital Sanctuary supplement but do not replace physical church involvement.`,
  },
  {
    source: "prayer-request-how-to",
    content: `JCTM invites all believers and seekers to submit prayer requests — the ministry's intercession team prays over every request received. How to submit a prayer request: Visit jctm.org.ng/prayer and complete the prayer request form. Your request is treated with complete confidentiality. The JCTM intercession team prays over submitted requests regularly. You may also share your prayer need directly with TempleBots for immediate prayer and scripture-based encouragement. For urgent pastoral needs, contact info@jctm.org.ng or +234(0)8081313111. Types of prayer requests JCTM receives and intercedes for: physical healing, deliverance from addiction or spiritual oppression, family restoration, financial breakthrough, salvation of loved ones, marital issues, career and life direction, grief and bereavement, spiritual dryness or doubt. JCTM believes in the power of corporate intercession (Matthew 18:19-20: "If two of you agree on earth concerning anything that they ask, it will be done for them by My Father in heaven"). Your request matters. 1 Thessalonians 5:17: "Pray without ceasing."`,
  },
  {
    source: "testimony-sharing-how-to",
    content: `Sharing your testimony is a powerful act of spiritual warfare and encouragement. Revelation 12:11: "They overcame him by the blood of the Lamb and by the word of their testimony." Your testimony of what God has done — healing, salvation, deliverance, breakthrough — strengthens the faith of others and glorifies God. How to share your testimony at JCTM: 1. Visit jctm.org.ng/testimonies and use the testimony submission form. 2. Include your name (or remain anonymous), the category of testimony (healing, salvation, deliverance, financial, etc.), and the full account of what God did. 3. Testimonies are reviewed by JCTM admin before publication to ensure they glorify God and are doctrinally appropriate. 4. Approved testimonies are featured in the Testimony Vault at jctm.org.ng/testimonies for the global community to read and be encouraged. 5. JCTM may share selected testimonies on Temple TV and social media (with your permission). A good testimony includes: what you were experiencing before, how you prayed or came to faith, what God did specifically, and how your life has changed. "Let the redeemed of the LORD say so." — Psalm 107:2.`,
  },
];
